...
!Задания для фронтендной части
Todo
1. Создать react-app и установить зависимости 

Todo
2. Начать делать верстку приветственного окна - входа в приложение

Todo
3. Сделать возможность аутентификации через окно входа и отобразить это

Todo
4. Делать верстку dashboard-а

Todo
5. Сделать возможность создания новых проектов и обновления данных пользователя
*/